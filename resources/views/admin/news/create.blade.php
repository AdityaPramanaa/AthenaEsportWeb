...
<div class="px-2 md:px-6 py-6">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-xl shadow overflow-hidden">
            <form action="{{ route('admin.news.store') }}" method="POST" enctype="multipart/form-data" id="createNewsForm" class="p-6">
                @csrf
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="content" id="content" rows="6" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-black">{{ old('content') }}</textarea>
                        @error('content')<p class="mt-1 text-sm text-red-600">{{ $message }}</p>@enderror
                    </div>
                    <div class="md:col-span-2">
                        <label for="image" class="block text-sm font-medium text-gray-700">Gambar <span class="text-red-500">*</span></label>
                        ...
                        <div id="imagePreview" class="mt-2 hidden">
                            <label class="block text-xs text-gray-500 mb-1">Preview Gambar:</label>
...
<script>
    ...
    document.getElementById('createNewsForm')?.addEventListener('submit', function() {
