...
<div class="px-2 md:px-6 py-6">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-xl shadow overflow-hidden">
            <form action="{{ route('admin.news.update', $news->id) }}" method="POST" enctype="multipart/form-data" id="editNewsForm" class="p-6">
                @csrf
                @method('PUT')
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="title" id="title" value="{{ old('title', $news->title) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-black">
                        @error('title')<p class="mt-1 text-sm text-red-600">{{ $message }}</p>@enderror
                    </div>
                    <div>
                        <label for="type" class="block text-sm font-medium text-gray-700">Tipe Berita <span class="text-red-500">*</span></label>
                    ...
                    <div class="md:col-span-2">
                        <label for="content" class="block text-sm font-medium text-gray-700">Konten <span class="text-red-500">*</span></label>
                        <textarea name="content" id="content" rows="6" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-black">{{ old('content', $news->content) }}</textarea>
                    ...
                    <div class="md:col-span-2">
                        ...
                        @if($news->image_path)
                            <div class="mt-2">
                                ...
                                <img src="{{ Storage::url($news->image_path) }}" alt="Current Image" class="max-h-48 rounded shadow">
                            </div>
                        @endif
